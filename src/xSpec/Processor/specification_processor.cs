...
{
	public class specification_processor
	{
		...
		private readonly specification_processor_result specification_processor_result;

		public IList<string> statements { get; set; }

		public specification_processor(specification specification)
		{
			this.specification = specification;
			this.statements = new List<string>();
			this.specification_processor_result = new specification_processor_result();
		}

		public specification_processor_result process()
		{
			...
			stopwatch.Stop();
			this.specification_processor_result.duration = stopwatch.ElapsedMilliseconds*1000; 
